...
public class FileCopyDemoCommon {
	...
	public static void displayDirectories(ApplicationContext context) {
		...
		LiteralExpression outDir = (LiteralExpression) new DirectFieldAccessor(context.getBean(FileWritingMessageHandler.class)).getPropertyValue("destinationDirectoryExpression");
		System.out.println("Input directory is: " + inDir.getAbsolutePath());
		System.out.println("Output directory is: " + outDir.getExpressionString());
		System.out.println("===================================================");
	}
